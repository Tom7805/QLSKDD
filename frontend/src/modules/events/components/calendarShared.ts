...
const CATEGORY_PALETTE: CalendarPalette[] = [
  { block: 'bg-violet-100 hover:bg-violet-200/80', bar: 'bg-violet-400', text: 'text-violet-950', meta: 'text-violet-700/75', chip: 'bg-violet-200/70 text-violet-900', dot: 'bg-violet-400', pill: 'bg-violet-500 hover:bg-violet-600', glow: 'shadow-violet-500/40' },
  { block: 'bg-sky-100 hover:bg-sky-200/80', bar: 'bg-sky-400', text: 'text-sky-950', meta: 'text-sky-700/75', chip: 'bg-sky-200/70 text-sky-900', dot: 'bg-sky-400', pill: 'bg-sky-500 hover:bg-sky-600', glow: 'shadow-sky-500/40' },
  { block: 'bg-amber-100 hover:bg-amber-200/80', bar: 'bg-amber-400', text: 'text-amber-950', meta: 'text-amber-700/75', chip: 'bg-amber-200/70 text-amber-900', dot: 'bg-amber-400', pill: 'bg-amber-500 hover:bg-amber-600', glow: 'shadow-amber-500/40' },
  { block: 'bg-emerald-100 hover:bg-emerald-200/80', bar: 'bg-emerald-400', text: 'text-emerald-950', meta: 'text-emerald-700/75', chip: 'bg-emerald-200/70 text-emerald-900', dot: 'bg-emerald-400', pill: 'bg-emerald-500 hover:bg-emerald-600', glow: 'shadow-emerald-500/40' },
  { block: 'bg-rose-100 hover:bg-rose-200/80', bar: 'bg-rose-400', text: 'text-rose-950', meta: 'text-rose-700/75', chip: 'bg-rose-200/70 text-rose-900', dot: 'bg-rose-400', pill: 'bg-rose-500 hover:bg-rose-600', glow: 'shadow-rose-500/40' },
  { block: 'bg-indigo-100 hover:bg-indigo-200/80', bar: 'bg-indigo-400', text: 'text-indigo-950', meta: 'text-indigo-700/75', chip: 'bg-indigo-200/70 text-indigo-900', dot: 'bg-indigo-400', pill: 'bg-indigo-500 hover:bg-indigo-600', glow: 'shadow-indigo-500/40' },
  { block: 'bg-teal-100 hover:bg-teal-200/80', bar: 'bg-teal-400', text: 'text-teal-950', meta: 'text-teal-700/75', chip: 'bg-teal-200/70 text-teal-900', dot: 'bg-teal-400', pill: 'bg-teal-500 hover:bg-teal-600', glow: 'shadow-teal-500/40' },
  { block: 'bg-fuchsia-100 hover:bg-fuchsia-200/80', bar: 'bg-fuchsia-400', text: 'text-fuchsia-950', meta: 'text-fuchsia-700/75', chip: 'bg-fuchsia-200/70 text-fuchsia-900', dot: 'bg-fuchsia-400', pill: 'bg-fuchsia-500 hover:bg-fuchsia-600', glow: 'shadow-fuchsia-500/40' },
];

const NO_CATEGORY_PALETTE: CalendarPalette = {
  block: 'bg-slate-100 hover:bg-slate-200', bar: 'bg-slate-300', text: 'text-slate-900', meta: 'text-slate-500', chip: 'bg-slate-200 text-slate-700', dot: 'bg-slate-300',
  pill: 'bg-slate-500 hover:bg-slate-600', glow: 'shadow-slate-500/40',
};
...
const CANCELLED_PALETTE: CalendarPalette = {
  block: 'bg-slate-100/70 hover:bg-slate-200/70', bar: 'bg-slate-300', text: 'text-slate-400 line-through', meta: 'text-slate-400', chip: 'bg-slate-200 text-slate-500', dot: 'bg-slate-300',
  pill: 'bg-slate-300 hover:bg-slate-400', glow: 'shadow-slate-400/30',
};
