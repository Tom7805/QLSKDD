...
const NAV_ITEMS: NavItem[] = [
  { label: 'Dashboard', to: ROUTES.DASHBOARD, allow: ['ROLE_ADMIN', 'ROLE_ORGANIZER'] },
  { label: 'Quản lý người tham gia', to: ROUTES.PARTICIPANTS, allow: ['ROLE_ADMIN', 'ROLE_ORGANIZER'] },
