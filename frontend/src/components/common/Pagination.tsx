interface PaginationProps {
  ...
  /** @deprecated Dùng onChange cho các màn hình mới. */
  onPageChange?: (page: number) => void;
}

export default function Pagination({ page, totalPages, onChange, onPageChange }: PaginationProps) {
  if (totalPages <= 1) return null;
  const changePage = onChange ?? onPageChange;
